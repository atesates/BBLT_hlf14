...
for USER_COUNT in 1 #1 2 5 10 20 50 100 200 500 1000
do
	echo "========================================"
	...
	locust -f locustfile.py --headless --host http://127.0.0.1:8080 -u $USER_COUNT -r $HATCH_RATE -t${DURATION}s --csv=${USER_COUNT}_users_${TYPE}
